{/* <script> */}
      ...
      function sendEmail() {
        var url = "https://api.disciplinedmindstutoring.com/createRecord/Containers";
        ...
        var fd = new FormData();
        fd.append('fieldName', 'htmlEmailId');
        fd.append('fieldValue', JSON.stringify(globalImgSrcBase64Encoded));
